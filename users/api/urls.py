...
from .views import RegistrationAPIView,SetPasswordView,LoginUserView, VerifyOTPAPIView, LogoutBlacklistTokenUpdateView,ResetPasswordConfirmView,ResetPasswordView,UpdateProfileView
