from .serializers import RegistrationSerializer,SetPasswordSerializer,LoginUserSerializer, VerifyOTPSerializer,ResetPasswordSerializer,ResetPasswordConfirmView
